...
func p5FEC2020Weak5205RunConfig(t *testing.T) (int, uint64) {
	t.Helper()
...
func TestP5FEC2020WeakNetwork5205MeasurementHarness(t *testing.T) {
	...
	runOrdinal, seed := p5FEC2020Weak5205RunConfig(t)
	...
	manifest := map[string]any{
		...
		"scenario": map[string]any{
			"name": "controlled-real-https-fec20x20-weaknet-5-20-5", "run_ordinal": runOrdinal, "seed": seed, "cryptographic_rng": "system",
